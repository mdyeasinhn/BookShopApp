            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="flex items-center justify-center space-x-2 py-2.5 px-4 border-2 border-orange-100 text-orange-600 rounded-xl hover:bg-orange-50 hover:border-orange-200 transition-all duration-200 font-medium"
                >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-6 pt-6 border-t border-orange-100 text-center">
                <p className="text-gray-600 text-sm">
                  ...
                  <Link
                    to="/register"
                    className="text-orange-500 hover:text-orange-700 font-semibold hover:underline transition-colors"
                  >
                    Sign up
                  </Link>
                </p>
